                    ...
                    <div class="card-body" style="padding: 0px !important;">
                        <div style="background-color: #E0F7FF; border-top: 2px solid #B3D7E5;">
                            <div class="container-fluid mt-5">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mt-2">{{ $transfer_uang->transfer_dari }}</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mt-2">{{ $transfer_uang->setor_ke }}</div>
                                    <div class="col-sm-4 mt-2 d-flex justify-content-end"><br><br></div>    
                                </div>
                                <div class="row">
                                    <div class="col-sm-2 mt-2">Tgl Transaksi:</div>
                                    <div class="col-sm-2 mt-2">{{ $transfer_uang->tanggal_transaksi }}</div>
                                    <div class="col-sm-4 mt-2 d-flex justify-content-end"><br><br></div>  
                                </div>
                                <div class="row mb-4">
                                    <div class="col-sm-2 mt-2">Tgl Transaksi:</div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6 d-flex justify-content-end">
                                ...
                                <a href="{{ url('kas_bank/transfer_uang') . '/' . $transfer_uang->id }}" class="btn btn-outline-primary">Ubah</a>
                            </div>
                        </div>
                    </div>
                </div>
