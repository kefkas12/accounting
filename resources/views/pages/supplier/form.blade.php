                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group row mb-2">
                                        <label for="nama" class="col-sm-4 col-form-label">Nama Supplier / Pemasok <span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label for="nomor_handphone" class="col-sm-4 col-form-label">Handphone</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label for="nomor_telepon" class="col-sm-4 col-form-label">No. Telp. Bisnis</label>
                                        <div class="col-sm-8">
