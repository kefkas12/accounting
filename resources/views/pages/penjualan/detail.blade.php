                ...
                <div class="card">
                    <div class="card-body border-0 text-sm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">No Transaksi <br> @if($penjualan->no_str)<strong>{{ $penjualan->no_str }}</strong>@else <strong> - </strong> @endif</div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4 pr-2">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col">
                                                <strong>@if($penjualan->pesan){{ $penjualan->pesan }} @else - @endif</strong>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <strong>@if($penjualan->pesan){{ $penjualan->memo }} @else - @endif</strong>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            <div class="col">
                                                Dokumen {{ $loop->index+1 }}
                                            </div>
                                            <div class="col">
                                                <strong>
                                                    <a href="{{ asset('storage/uploads') }}/{{ $v->nama }}" target="_blank"> {{ $v->dokumen->nama }}</a>
                                                </strong>
                                            </div>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <form method="POST" action="{{ url('penjualan/status_pengiriman') }}">
                                            ...
                                            <div class="row mb-1">
                                                ...
                                                <div class="col d-flex justify-content-end">
                                                    <select class="form-control form-control-sm" name="status_pengiriman" id="status_pengiriman" required>
