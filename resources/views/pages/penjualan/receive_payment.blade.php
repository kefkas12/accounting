                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row">
                            <div class="col-sm-8">Transaksi <br>
                                <h2>{{ $detail_pembayaran_penjualan[0]->pembayaran_penjualan->no_str }}</h2></div>
                    ...
                    <div class="card-body" style="padding: 0px !important;">
                        <div style="background-color: #E0F7FF; border-top: 2px solid #B3D7E5;">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-4 d-flex justify-content-end">
                                    <h2>Total <span id="total_pembayaran" style="color:#2980b9">Rp. {{ number_format($detail_pembayaran_penjualan[0]->pembayaran_penjualan->subtotal,2,',','.') }}</span><br> 
                        ...
                        <div class="mt-3 mb-5">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    {{ $detail_pembayaran_penjualan[0]->pembayaran_penjualan->cara_pembayaran }}
                                </div>
                                <div class="col-sm-3">{{ $detail_pembayaran_penjualan[0]->pembayaran_penjualan->tanggal_transaksi }}</div>
                                <div class="col-sm-3">{{ $detail_pembayaran_penjualan[0]->pembayaran_penjualan->tanggal_jatuh_tempo }}</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel"><div class="text-xs mb-1">Laporan Jurnal</div><strong>{{ $detail_pembayaran_penjualan[0]->pembayaran_penjualan->no_str }}</strong></h4>
