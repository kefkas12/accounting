...
@section('content')
                    ...
                    >
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group has-float-label col-md-3 pr-4" hidden>
                                ...
                                <div class="col-md-3 pr-4">
                                    <div class="form-group has-float-label" hidden>
                                ...
                                <div class="col-md-3 info_pengiriman pr-4" style="display:none">
    ...
    <script>
        ...
        function create_row() {
            ...
            $('#list').append(`
                <tr id="list_${i}">
                    ...
                    <td style="padding: 10px !important;" id="harga_satuan_td_${i}"><input type="number" class="form-control" id="harga_satuan_${i}" name="harga_satuan[]" value="0" onkeyup="change_jumlah(${i})" onblur="check_null(this)" step="any" @if(isset($pemesanan)) disabled @endif></td>
                    ...
                    <td style="padding: 10px !important;" id="jumlah_td_${i}"><input type="number" class="form-control" id="jumlah_${i}" name="jumlah[]" value="0" step="any" @if(isset($pemesanan)) disabled @endif></td>
        ...
        $( document ).ready(function() {
            ...
            $('#tanggal_pengiriman').val('{{ $penjualan->tanggal_pengiriman }}')
