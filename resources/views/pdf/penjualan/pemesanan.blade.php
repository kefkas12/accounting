...
<head>
  ...
  <title>Pemesanan Penjualan</title>
  ...
  <div class="container mt-5">
    ...
    <div class="row mb-4">
      <div class="col border">
        NAMA : {{ $penjualan->nama }} <br>
        ALAMAT : {{ $penjualan->alamat }} <br>
        NO HP : {{ $penjualan->nomor_handphone }} <br>
        FAX : {{ $penjualan->fax }} <br>
      </div>
      <div class="col border">
        JATUH TEMPO {{ date('d/m/Y',strtotime($penjualan->tanggal_jatuh_tempo)) }}
      </div>
    </div>
        ...
        <table class="table table-bordered">
          <thead>
            ...
            <tr>
              ...
              <th scope="col">{{ number_format($penjualan->sisa_tagihan,0,',','.') }}</th>
            </tr>
          </thead>
        </table>
      </div>
